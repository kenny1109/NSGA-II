...
evo = Evolution(problem, num_of_generations=500, num_of_individuals=100, crossover_param=5, mutation_param=2000)
evol = evo.evolve()
for i in evol:
    print(i.features)
...
func2 = [1-math.sqrt(x_set[i]) for i in range(1000)]
...
plt.legend(loc=1)
path = os.getcwd()
plt.savefig(path + '/../pictures/ZDT1/ZDT1')
plt.show()
